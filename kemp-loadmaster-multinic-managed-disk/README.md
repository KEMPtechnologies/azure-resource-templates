# KEMP LoadMaster Multi-NIC with Managed Disks
...
This template deploys a KEMP LoadMaster with multiple NICs using Managed Disks. Doing so will enabled the Virtual LoadMaster to have more than one interface and expose additional fucntionality such as:
