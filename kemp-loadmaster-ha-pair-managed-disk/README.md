# KEMP LoadMaster HA Pair with Managed Disks
...
This template deploys a KEMP LoadMaster high availability (HA) Pair using Managed Disks. Once deployed an end-user can setup two KEMP Virtual LoadMasters as outlined in the [LoadMaster Documentation](https://support.kemptechnologies.com/hc/en-us/articles/203859775-HA-for-Azure-Marketplace-Classic-Interface-)
